      ...
      <div className="book-viewer-screen">
        <header>
        	<nav className="navbar navbar-expand-lg navbar-light bg-light">
    		  <a className="navbar-brand" href="#"><img src="/images/logo.png"/>Ibook</a>
    		        ...
    		        <div className="dropdown-menu" aria-labelledby="navbarDropdown">
    		          <form className="form-group">
    		          	<div className="option">
    		          		<div className="col-md-5 col-xs-12" htmlFor="truyen-background">Màu nền</div>
    		          		<div className="col-md-7 col-xs-12">
    		          			<select className="form-control" id="truyen-background">
    		          	...
    		          	<div className="option">
    		          		<div className="col-md-5" htmlFor="truyen-background">Phông chữ</div>
    		          		<div className="col-md-7">
    		          			<select className="form-control" id="font-chu">
    		          	...
    		          	<div className="option">
    		          		...
    		          		<div className="col-md-7">
    		          			<select className="form-control" id="size-chu">
        	...
        	<div className="container">
        		<div className="title">
        			...
        			<div className="book-chapter">
        				<center>Chapter 1: {chapter.name}</center>
        			</div>
        			<center>
    	    			<div className="btn-group btn-nav">
    	    				<a onClick={this.prevChapter}>
    	    					<i className="fas fa-angle-left"></i>
    	    					<span className="next">Chương trước</span>
    	    				</a>
    	    				<select className="form-control select-chapter" value={chapter.id} onChange={e=>this.onChangeChapter(e.target.value)}>
                    {
                      this.state.chapters.map((chapter, index)=>(
                        <option value={chapter.id}>Chương {index+1}</option>
                      ))
                    }
                  </select>
    	    				<a onClick={this.nextChapter}>
    	    					<span className="next">Chương sau</span>
    	    					<i className="fas fa-angle-right"></i>
    	    				</a>
    	    			</div>
        			</center>
        		</div>
            <div className="ck-content" dangerouslySetInnerHTML={{__html: chapter.content}}/>
        	</div>
        </content>
